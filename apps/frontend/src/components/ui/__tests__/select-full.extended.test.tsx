/**
 * Tests extendidos para los componentes Select de select-full.tsx
 * Verifica renderizado, estilos y props de los componentes Select con scroll buttons
 * 
...
describe('SelectFull Components (Extended)', () => {
  describe('Select Root', () => {
    ...
    it('debe soportar valor por defecto', () => {
      render(
  ...
  describe('SelectTrigger', () => {
    ...
    it('debe aplicar line-clamp al contenido', () => {
      render(
        <Select>
          <SelectTrigger data-testid="trigger">
            <SelectValue placeholder="Un texto muy largo que debería ser truncado" />
          </SelectTrigger>
        </Select>
      );
  ...
  describe('SelectScrollUpButton', () => {
    it('debe exportar SelectScrollUpButton', () => {
      expect(SelectScrollUpButton).toBeDefined();
    });
  });

  describe('SelectScrollDownButton', () => {
    it('debe exportar SelectScrollDownButton', () => {
