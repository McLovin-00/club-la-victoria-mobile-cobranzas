...
export const createQueryMock = (data: any, isLoading = false, error: any = null) => ({
    data,
    isLoading,
 ...
 */
export const createDocumentosApiSliceMock = (overrides: any = {}) => ({
 ...
 */
export const createDocumentosApiSliceMockForEdit = (overrides: any = {}) => ({
 ...
 */
export const createPlatformUsersApiSliceMock = (overrides: any = {}) => ({
 ...
 * Mock de store Redux
 */
export const createMockStore = (authState: any = {}) => ({
    dispatch: jest.fn(),
    getState: jest.fn(() => ({
        auth: {
