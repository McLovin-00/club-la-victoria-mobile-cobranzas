...
import DashboardDadoresPage from '../DashboardDadoresPage';
...
function renderPage() {
  ...
  return render(
    <Provider store={store}>
      <MemoryRouter initialEntries={['/documentos/dashboard']}>
...
describe('DashboardDadoresPage (render)', () => {
  it('renderiza el título sin crashear', () => {
    renderPage();
    expect(screen.getByText('Dashboard de Dadores')).toBeInTheDocument();
  });
});
