/**
 * Tests de cobertura para DashboardDadoresPage
 */
...
describe('DashboardDadoresPage - Coverage', () => {
  ...
  beforeAll(async () => {
    ...
    await jest.unstable_mockModule('../../api/documentosApiSlice', () => ({
      useGetDadoresSummaryQuery: () => ({
        data: { dadores: [], stats: { total: 0, activos: 0, inactivos: 0 } },
        isLoading: false,
      }),
      ...
      useUploadBatchDocsDadorMutation: () => [jest.fn(), { isLoading: false }],
    }));
    ...
    Component = module.default || module.DashboardDadoresPage;
  });
