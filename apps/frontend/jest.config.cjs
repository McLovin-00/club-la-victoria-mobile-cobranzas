...
module.exports = {
  ...
  collectCoverageFrom: [
    // Incluir código fuente general
    'src/**/*.{ts,tsx}',
    // Exclusiones técnicas: tipos, tests, stories, entry points
    '!src/**/*.d.ts',
    '!src/**/*.test.{ts,tsx}',
    '!src/**/*.spec.{ts,tsx}',
    '!src/**/*.stories.{ts,tsx}',
    ...
    '!src/main.tsx',
    '!src/App.tsx',
    // Excluir configuración de tests
    '!src/test-utils/**',
    '!src/__tests__/**',
    // Excluir constantes y tipos puros (no tienen lógica que probar)
    '!src/constants/**',
    '!src/types/**',
  ],
